function Leg(response, options){
  ...
  this.stationType = response.oc.travelMode;

  this.tripTime = this.googleLegObject.duration.value;
  this.TARGET_TIME = 1500;
  this.MIN_BUFFER = 150;
  this.ON_ROUTE_DISTANCE = 0.001; // change to .001
  // this.closestStations = [];
  // this.stationsOnLeg = [];
  this.timeIntoLeg = 0;
  this.steps = [];
  for(var i = 0 ; i < this.googleLegObject.steps.length; i++){
    var currentStep = new Step(this.googleLegObject.steps[i]);
